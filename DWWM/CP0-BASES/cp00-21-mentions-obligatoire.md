...
Découvrez la liste des mentions obligatoires qui doivent apparaître sur votre site web.

## Sommaire
- Les mentions obligatoires pour tous les sites web
...
Les [mentions légales](https://www.economie.gouv.fr/entreprises/site-internet-mentions-obligatoires) désignent les informations qui doivent obligatoirement figurer sur un support de communication. Sur Internet, tous les sites web sont concernés, qu’ils soient destinés à un usage personnel ou professionnel : ils ont pour but d’informer le visiteur et de responsabiliser l’éditeur.
...
### 1. Identification
- Nom et prénom, Adresse du domicile, Adresse email, Numéro de téléphone

#### 2. Informations professionnelles
- Numéro SIRET, Immatriculation (RCS ou RM), Numéro de TVA intracommunautaire (si applicable)
...
- Autorisations ou sources si contenus tiers

#### 6. Cas particuliers
- Professions réglementées : autorité de tutelle
- Site non professionnel : 
    - régime allégé possible 
    - coordonnées non affichées mais transmises à l'hébergeur
...
Les obligations légales que doivent respecter les sites web varient selon leur nature.
