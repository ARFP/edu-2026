...
```mermaid
graph LR
    A1[1. Mémoriser] --> A2[2. Comprendre]
    A2 --> A3[3. Appliquer]
    A3 --> A4[4. Analyser]
    A4 --> A5[5. Évaluer]
    A5 --> A6[6. Créer]
    ...
    style A3 fill:#FFFDE7,stroke:#F57F17
    style A4 fill:#F3E5F5,stroke:#4A148C
    style A5 fill:#E0F7FA,stroke:#006064
...
*Objectif : Connaître le vocabulaire et les outils du design d'interface.*
...
*Objectif : Saisir les principes d'ergonomie et d'accessibilité numérique.*
...
### Niveau 3 : Appliquer (Exécuter les gestes techniques)

*Objectif : Manipuler les outils pour reproduire une structure visuelle.*
...
*Objectif : Étudier un besoin client pour le transformer en parcours utilisateur.*
...
* **Actions décomposées :**
    1. Lister les écrans nécessaires pour une action (ex: "Finaliser la commande").
...
### Niveau 5 : Évaluer (Vérifier et tester)

*Objectif : Contrôler la qualité et la conformité de la maquette.*
...
### Niveau 6 : Créer (Construire et prototyper)

*Objectif : Produire un prototype interactif complet prêt pour le développement.*
...
### Modalités d'évaluation (Conformes au REV2)

* **Mise en situation :** Création d'une maquette mobile à partir d'une User Story.
